...
/// {@macro flutter_rust_bridge.only_for_generated_code}
// wasm-bindgen returns a JavaScript array. dart2js historically allowed that
// value to cross the interop boundary as a Dart List, but dart2wasm correctly
// keeps it as JSAny. Dartify it explicitly in manual_impl/_web.dart.
typedef WireSyncRust2DartDco = JSAny?;
