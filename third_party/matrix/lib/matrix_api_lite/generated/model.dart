...
class Contact {
  ...
  Contact.fromJson(Map<String, Object?> json)
    : emailAddress = ((v) =>
          v != null ? v as String : null)(json['email_address']),
...
class GetAuthMetadataResponse {
  ...
  GetAuthMetadataResponse.fromJson(Map<String, Object?> json)
    : accountManagementActionsSupported = ((v) => v != null
      ...
      registrationEndpoint = Uri.parse(json['registration_endpoint'] as String),
...
class PublishedRoomsChunk {
  ...
  PublishedRoomsChunk.fromJson(Map<String, Object?> json)
    : avatarUrl = ((v) =>
      ...
      canonicalAlias = ((v) =>
          v != null ? v as String : null)(json['canonical_alias']),
...
class GetRoomSummaryResponse$2 {
  GetRoomSummaryResponse$2({this.membership});
  ...
  Map<String, Object?> toJson() {
    ...
    return {if (membership != null) 'membership': membership.name};
  }
...
class LoginFlow {
  ...
  LoginFlow.fromJson(Map<String, Object?> json)
    : getLoginToken = ((v) =>
          v != null ? v as bool : null)(json['get_login_token']),
      type = json['type'] as String,
      additionalProperties = Map.fromEntries(
        json.entries
...
class RegisterResponse {
  ...
  RegisterResponse.fromJson(Map<String, Object?> json)
    : accessToken = ((v) =>
          v != null ? v as String : null)(json['access_token']),
      deviceId = ((v) => v != null ? v as String : null)(json['device_id']),
      expiresInMs = ((v) => v != null ? v as int : null)(json['expires_in_ms']),
      homeServer = ((v) => v != null ? v as String : null)(json['home_server']),
      refreshToken = ((v) =>
...
class RoomEventFilter {
  ...
  RoomEventFilter.fromJson(Map<String, Object?> json)
    : containsUrl = ((v) => v != null ? v as bool : null)(json['contains_url']),
      ...
      lazyLoadMembers = ((v) =>
          v != null ? v as bool : null)(json['lazy_load_members']),
      notRooms = ((v) => v != null
          ? (v as List).map((v) => v as String).toList()
          : null)(json['not_rooms']),
      rooms = ((v) => v != null
  ...
  RoomEventsCriteria.fromJson(Map<String, Object?> json)
    : eventContext = ((v) => v != null
      ...
      groupings = ((v) => v != null
          ...
          : null)(json['groupings']),
      includeState = ((v) =>
          v != null ? v as bool : null)(json['include_state']),
      keys = ((v) => v != null
          ? (v as List)
...
class Protocol {
  ...
  Protocol.fromJson(Map<String, Object?> json)
    : fieldTypes = (json['field_types'] as Map<String, Object?>).map(
      ...
      locationFields = (json['location_fields'] as List)
          .map((v) => v as String)
          .toList(),
      userFields = (json['user_fields'] as List)
          .map((v) => v as String)
          .toList();
  Map<String, Object?> toJson() => {
...
class GetProtocolMetadataResponse$1 {
  GetProtocolMetadataResponse$1({required this.instances});
...
class GetProtocolsResponse$1 {
  GetProtocolsResponse$1({required this.instances});
  ...
  RoomFilter.fromJson(Map<String, Object?> json)
    : accountData = ((v) => v != null
      ...
      ephemeral = ((v) => v != null
          ...
          : null)(json['ephemeral']),
      includeLeave = ((v) =>
          v != null ? v as bool : null)(json['include_leave']),
      notRooms = ((v) => v != null
          ? (v as List).map((v) => v as String).toList()
          : null)(json['not_rooms']),
      rooms = ((v) => v != null
...
class CreateContentResponse {
  ...
  CreateContentResponse.fromJson(Map<String, Object?> json)
    : contentUri = ((json['content_uri'] as String).startsWith("mxc://")
          ...
          : throw Exception("Uri not an mxc URI")),
      unusedExpiresAt = ((v) =>
          v != null ? v as int : null)(json['unused_expires_at']);
  Map<String, Object?> toJson() {
